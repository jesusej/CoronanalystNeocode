...
--
-- Servidor: 127.0.0.1
-- Tiempo de generaci√≥n: 29-04-2021 a las 02:06:51
...
INSERT INTO `cuenta` (`idCuenta`, `idTipo_De_Cuenta`, `Usuario`, `Contrase√±a`) VALUES
...
(105, 1, 'No realizaba compras en lÌnea'),
(201, 2, 'Mercado Libre'),
(202, 2, 'Amazon'),
...
(207, 2, 'Otros'),
(208, 2, 'No realizaba compras en lÌ≠nea'),
(301, 3, 'Tarjeta de crÈdito'),
(302, 3, 'Tarjeta de dÈbito'),
(303, 3, 'Paypal'),
(304, 3, 'Mercado Pago'),
(305, 3, 'Efectivo'),
(306, 3, 'Transferencia electrÛnica'),
(307, 3, 'DepÛsito en tiendas de conveniencia (Oxxo, 7Eleven, etc.)'),
(308, 3, 'Otro'),
(309, 3, 'No realizaba compras en lÌnea'),
(401, 4, 'Ropa'),
(402, 4, 'Comida a domicilio (Rappi, UberEats, etc.)'),
(403, 4, 'Super a domicilio (v√≠veres)'),
(404, 4, 'Muebles y/o electrodom√©sticos'),
(405, 4, 'Coleccionables'),
(406, 4, 'Libros (fÌ≠sicos o electrÛnicos)'),
(407, 4, 'Computadoras y/o electrÛnicos'),
(408, 4, 'Herramientas y ferreterÌa'),
(409, 4, 'Entretenimiento (m˙sica, tv, videojuegos, juguetes, etc.)'),
(410, 4, 'Programas o aplicaciones'),
(411, 4, 'Reservaciones y boletos'),
(412, 4, 'Art√≠culos de higiene'),
(413, 4, 'Art√≠¬≠culos deportivos'),
(414, 4, 'No realizaba compras en lÌnea'),
(415, 4, 'Otros'),
(501, 5, '7 horas o m·s al dÌ≠a'),
(502, 5, '6 a 2 horas al dÌa'),
...
(605, 6, 'No realizo compras en lÌ≠nea'),
(701, 7, 'Mercado Libre'),
(702, 7, 'Amazon'),
...
(707, 7, 'Otros'),
(708, 7, 'No realizo compras en lÌnea'),
(801, 8, 'Tarjeta de crÈdito'),
(802, 8, 'Tarjeta de dÈbito'),
(803, 8, 'Paypal'),
(804, 8, 'Mercado Pago'),
(805, 8, 'Efectivo'),
(806, 8, 'Transferencia ElectrÛnica'),
(807, 8, 'DepÛsito en tiendas de conveniencia (Oxxo, 7Eleven, etc.)'),
(808, 8, 'Otro'),
(809, 8, 'No realizo compras en lÌnea'),
(901, 9, 'Ropa'),
(902, 9, 'Comida a domicilio (Rappi, UberEats, etc.)'),
(903, 9, 'Super a domicilio (vÌveres)'),
(904, 9, 'Muebles y/o electrodom√©sticos'),
(905, 9, 'Coleccionables'),
(906, 9, 'Libros (fÌ≠sicos o electrÛnicos)'),
(907, 9, 'Computadoras y/o electrÛnicos'),
(908, 9, 'Herramientas y ferreterÌ≠a'),
(909, 9, 'Entretenimiento (m˙sica, tv, videojuegos, juguetes, etc.)'),
(910, 9, 'Programas o aplicaciones'),
(911, 9, 'Reservaciones y boletos'),
(912, 9, 'Art√≠culos de higiene'),
(913, 9, 'Art√≠culos deportivos'),
(914, 9, 'No realizaba compras en lÌnea'),
(915, 9, 'Otros'),
(1001, 10, '7 horas o m·s al dÌa'),
(1002, 10, '6 a 2 horas al dÌ≠a'),
...
(1502, 15, 'EstrÈs'),
(1503, 15, 'DepresiÛn'),
(1504, 15, 'DÈficit de atenciÛn'),
(1505, 15, 'Baja de rendimiento laboral/acadÈmico'),
(1506, 15, 'Baja autoestima'),
(1507, 15, 'Otros no enlistados'),
(1508, 15, 'No me he sentido afectado'),
(1601, 16, 'AumentÛ'),
(1602, 16, 'PermaneciÛ igual que antes'),
(1603, 16, 'DisminuyÛ');
...
(1, 'øQuÈ tan seguido compraba en lÌnea?', 'Radio'),
(2, 'øQuÈ plataformas utilizaba para realizar compras en lÌ≠nea?', 'Checkbox'),
(3, 'øQuÈ mÈtodos de pago utilizaba m·s para realizar sus compras en lÌnea?', 'Checkbox'),
(4, 'øDe cu·les de las siguientes categorÌ≠as realizaba compras?', 'Checkbox'),
(5, 'øCu·nto tiempo estima que se encontraba usando la computadora para actividades diarias?', 'Radio'),
(6, 'øQuÈ tan seguido compra en lÌnea ahora?', 'Radio'),
(7, 'øQuÈ plataformas utiliza para realizar compras en lÌ≠nea?', 'Checkbox'),
(8, 'øQuÈ mÈtodo de pago utiliza usted para sus compras en internet?', 'Checkbox'),
(9, 'øDe cu·les de las siguientes categorÌas ha realizado compras?', 'Checkbox'),
(10, 'øCu·nto tiempo estima que usa la computadora para actividades diarias? ', 'Radio'),
(11, 'øEn promedio cu+anto dinero estima que gasta en compras en lÌ≠nea al mes?', 'Radio'),
(12, 'øActualmente compras m·s seguido en fÌ≠sico o en lÌnea?', 'Radio'),
(13, 'øDesde que empezÛ la pandemia, ha presentado sÌ≠ntomas relacionados al COVID-19?', 'Radio'),
(14, 'øUsted sufre de alguna de las siguientes condiciones mÈdicas?', 'Checkbox'),
(15, 'øA causa de la pandemia usted se ha sentido relacionado con algunas de las siguientes situaciones?', 'Checkbox'),
(16, 'Durante la pandemia, øcÛmo ha cambiado su actividad fÌsica?', 'Radio');
