...
//            colors: ['', ''], //cambia color, pero no se me ocurre a que color ponerlo ahorita
            ...
            data={[
            ['Respuesta', 'Antes de Pandemia', 'Despues de Pandemia'],
            [response.data[22].Opcion, response.data[22].total, 0],
            [response.data[23].Opcion, response.data[23].total, 0],
            [response.data[24].Opcion, response.data[24].total, 10],
